...
const Login = () => {
  ...
  // Handle pending messages after successful login
  ...
  // Listen for auth state changes to handle pending messages
  useEffect(() => {
      ...
      <Card>
        <CardHeader className="space-y-1">
          ...
          <CardDescription className="text-center">
            Sign in to continue your emotional support journey
          </CardDescription>
        </CardHeader>
