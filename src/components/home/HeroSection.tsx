      ...
      <div className="container">
        <div className="max-w-4xl mx-auto text-center">
          <div className="animate-fade-up">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">Your 24/7 space when bad bosses, imposter syndrome, and desk dread feel too heavy to carry alone</p>
