      ...
      <div className="container">
        <div className="max-w-4xl mx-auto text-center">
          <div className="animate-fade-up">
            ...
            <p className="text-xl text-muted-foreground mb-4 max-w-2xl mx-auto">Your always-on, AI-powered ally who listens, guides, and never judges</p>
            <p className="text-md text-clarly-600 font-medium mb-8 max-w-2xl mx-auto">Try premium features free for 7 days when you sign up!</p>
