      ...
      <div className="container">
        <div className="max-w-4xl mx-auto text-center">
          <div className="animate-fade-up">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">A 24/7 AI-powered sanity line for anyone burned out by bad bosses, imposter syndrome, and desk dread</p>
