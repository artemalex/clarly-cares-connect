...
const PricingSection = () => {
  return <section className="py-16 bg-gradient-to-b from-white to-muted/30">
      <div className="container">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">Unlimited 24/7 HelloClari chats—cheaper than lunch, priceless for peace of mind.</p>
